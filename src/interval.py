...
class Intervals(object):
    ...
    def make_interval_2D(self, p_min, p_max, step):
        ...
        int_pts = [Point2D( 5, 5),Point2D(13, 5),Point2D(13,11),Point2D(15,11),
                   Point2D(15,15),Point2D(13,15),Point2D(13,13),Point2D( 5,13)]
        int_rec = [(int_pts[0],int_pts[6]),(int_pts[2],int_pts[4])]
        self.interval2D = Interval2D(int_pts, int_rec)
